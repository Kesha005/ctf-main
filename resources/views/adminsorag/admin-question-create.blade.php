                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-8">
                            <form action="{{route('store')}}" method="post">
                                ...
                                <div class="form-group mb-3">
                                    <label for="exampleInputEmail1">Barlagçy1</label>
                                    <input name="barlag1" type="text" class="form-control" placeholder="Barlag1">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="exampleInputEmail1">Barlagçy2</label>
                                    <input name="barlag2" type="text" class="form-control" placeholder="Barlag2">
                                </div>
                                <div class="form-group mb-3">
